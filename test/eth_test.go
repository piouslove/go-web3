...
func TestSendTransaction(t *testing.T) {
	...
	unlocked, err := ethClient.Personal.UnlockAccount("0x00035DB1C858Fe4C2772a779C6fEF0FdB850dE42", "password", 10)
	...
	transaction, err := ethClient.Eth.SendTransaction("0x00035DB1C858Fe4C2772a779C6fEF0FdB850dE42", "0x007C0C7a7aB4aeDEE49bAb4c3a7dBfF9C675edCA", 1*web3.Coin, "0x")
